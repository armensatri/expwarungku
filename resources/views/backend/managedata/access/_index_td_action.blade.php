  ...
  <div class="m-1 hs-dropdown text-center
    ...
    <div role="menu"
      ...
      <div class="flex gap-2">
        <div>
          <a href="{{ route('access.menu', ['url' => $role->url]) }}"
            class="inline-flex items-center justify-center px-2.5 py-2.5 border border-gray-400 rounded-xl hover:bg-blue-100">

            <img src="/backend/img/menu/menus.jpg"
              alt="access-menu"
              class="size-4"
            />
          </a>

          <a href="{{ route('access.submenu', ['url' => $role->url]) }}"
            class="inline-flex items-center justify-center px-2.5 py-2.5 border border-gray-400 rounded-xl hover:bg-blue-100">

            <img src="/backend/img/menu/submenus.jpg"
              alt="access-submenu"
              class="size-4"
            />
          </a>

          <a href="{{ route('access.permission', ['url' => $role->url]) }}"
            class="inline-flex items-center justify-center px-2.5 py-2.5 border border-gray-400 rounded-xl hover:bg-blue-100">

            <img src="/backend/img/menu/permissions.jpg"
